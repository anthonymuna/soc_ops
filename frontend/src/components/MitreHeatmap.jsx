...
export default function MitreHeatmap({ history }) {
        ...
        {visibleTechniques.map(t => {
          ...
          return (
            <div
              ...
              className={`bg-gradient-to-br ${colors} border rounded p-1.5 text-center cursor-default
                transition-all duration-300 ${count > 0 ? 'ring-1 ring-white/10' : 'opacity-40'}`}
              style={{ opacity: count > 0 ? 0.4 + heat * 0.6 : 0.2 }}
            >
